...
-- 이름 변경
--ALTER TABLE book RENAME COLUMN price TO saleprice; -- 테이블 항목명 변경
-- 자료형 변경
--ALTER TABLE book MODIFY bookname VARCHAR2(60); -- 추가는 ADD
...
SELECT publisher
FROM book
WHERE bookname LIKE '축구의 역사'; -- 공백도 문자, 정확하게 써야 함 / 문자의 경우 = 대신 LIKE 써도 무방
